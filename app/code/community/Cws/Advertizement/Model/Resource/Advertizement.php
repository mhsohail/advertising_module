...
class Cws_Advertizement_Model_Resource_Advertizement extends Mage_Core_Model_Resource_Db_Abstract
{
    protected function _construct()
    {
        $this->_init('advertizement/advertizement','advertizement_id');
    }
}
